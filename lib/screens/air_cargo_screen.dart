...
class AirCargoScreen extends StatefulWidget {
  const AirCargoScreen({super.key});

  @override
  _AirCargoScreenState createState() => _AirCargoScreenState();
}

class _AirCargoScreenState extends State<AirCargoScreen> {
  ...
  final List<String> _cargoTypes = ['Air Cargo Door To Door'];
