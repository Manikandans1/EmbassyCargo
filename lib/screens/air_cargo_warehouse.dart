...
class AirCargoWarehouse extends StatefulWidget {
  const AirCargoWarehouse({super.key});

  @override
  _AirCargoWarehouseScreenState createState() => _AirCargoWarehouseScreenState();
}

class _AirCargoWarehouseScreenState extends State<AirCargoWarehouse> {
  ...
  final List<String> _cargoTypes = ['Air Cargo Warehouse Collection'];
  ...
  bool isLoading = false; // Add a state variable for loading status
  ...
  Future<void> sendOtp(String senderNumber) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Handle failure
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Failed to send OTP",style: const TextStyle(
          color: Colors.white,
      ...
      // Handle error
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Error: $e",style: const TextStyle(
        color: Colors.white,
        fontWeight: FontWeight.bold,
      ),),backgroundColor: Colors.blue,));
    } finally {
  ...
  void submitBooking() async {
    if (_nameController.text.isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Please fill all fields before submitting!',style: const TextStyle(
          color: Colors.white,
          fontWeight: FontWeight.bold,
        ),),backgroundColor: Colors.blue,),
      );
              ...
              Container(
                ...
                decoration: const BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage('assets/images/airbg.png'),
                    fit: BoxFit.contain,
                  ),
                ),
              ),
