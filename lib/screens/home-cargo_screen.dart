...
class HomeCargoScreen extends StatefulWidget {
  const HomeCargoScreen({super.key});

  @override
  _HomeCargoScreenState createState() => _HomeCargoScreenState();
}

class _HomeCargoScreenState extends State<HomeCargoScreen> {
  ...
  final List<String> _cargoTypes = ['Sea Cargo Warehouse Collection'];
