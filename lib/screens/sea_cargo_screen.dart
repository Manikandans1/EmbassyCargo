...
class SeaCargoScreen extends StatefulWidget {
  const SeaCargoScreen({super.key});

  @override
  _SeaCargoScreenState createState() => _SeaCargoScreenState();
}

class _SeaCargoScreenState extends State<SeaCargoScreen> {
  ...
  final List<String> _cargoTypes = ['Sea Cargo Door To Door'];
              ...
              Container(
                ...
                decoration: const BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage('assets/images/shippp.png'),
                    fit: BoxFit.contain,
                  ),
                ),
              ),
