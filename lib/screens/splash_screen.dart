...
class _SplashScreenState extends State<SplashScreen> with SingleTickerProviderStateMixin {
  ...
  void _navigateBasedOnConnectivity(bool hasInternet) {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => hasInternet ? HomeScreen() : NoInternetScreen()),
    );
  }
  ...
  Widget build(BuildContext context) {
    double screenWidth = MediaQuery.of(context).size.width;
    double logoSize = screenWidth * 0.5;
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Shimmer.fromColors(
              baseColor: primaryColor,  // Your primary color
              highlightColor: Color(0xFFFFD700), // Gold shimmer effect
              child: Text(
                'Embassy Cargo',
                style: GoogleFonts.roboto(
                  fontSize: fontSize,
